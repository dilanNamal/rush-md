...
const playcommand = async (m, Matrix) => {
  ...
  if (validCommands.includes(cmd)) {
    ...
    try {
      ...
      const buttons = [
        { "name": "quick_reply", "buttonParamsJson": JSON.stringify({ display_text: "🎶 RUSH SEVER1", id: `media_audio_${searchIndex}` }) },
        ...
        { "name": "quick_reply", "buttonParamsJson": JSON.stringify({ display_text: "🎶 RUSH ASHU ACADEMY YOUTUBE SUPPORT ", id: `media_videodoc_${searchIndex}` }) },
        ...
        viewOnceMessage: {
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              ...
              footer: proto.Message.InteractiveMessage.Footer.create({ text: "© Powered By RUSH-𝞛𝘿" }),
    ...
    if (selectedId.startsWith('next_')) {
      ...
      const buttons = [
        { "name": "quick_reply", "buttonParamsJson": JSON.stringify({ display_text: "🎶 RUSH SEVER1", id: `media_audio_${nextIndex}` }) },
        ...
        { "name": "quick_reply", "buttonParamsJson": JSON.stringify({ display_text: "🎶 RUSH ASHU ACADEMY YOUTUBE SUPPORT ", id: `media_videodoc_${nextIndex}` }) },
